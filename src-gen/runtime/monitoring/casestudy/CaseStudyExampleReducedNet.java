...
public class CaseStudyExampleReducedNet extends LogicalNet {
  private static final LogicalLocality CaseStudyExampleReduced = new LogicalLocality("CaseStudyExampleReduced");

  public static class CaseStudyExampleReduced extends ClientNode {
    private static class CaseStudyExampleReducedProcess extends KlavaNodeCoordinator {
      @Override
      public void executeProcess() {
        try {
          ...
          out(new Tuple(new Object[] {"WarningDetected"}), monitorLoc);
          Thread.sleep(1000);
    ...
    public CaseStudyExampleReduced() {
      super(new PhysicalLocality("localhost:9999"), new LogicalLocality("CaseStudyExampleReduced"));
    }

    public void addMainProcess() throws IMCException {
      KlavaNodeCoordinator _coordinator = new CaseStudyExampleReducedNet.CaseStudyExampleReduced.CaseStudyExampleReducedProcess();
      setMainCoordinator(_coordinator);
      addNodeCoordinator(_coordinator);
    }
  }

  public CaseStudyExampleReducedNet() throws IMCException {
    super(new PhysicalLocality("localhost:9999"));
  }

  public void addNodes() throws IMCException {
    CaseStudyExampleReducedNet.CaseStudyExampleReduced caseStudyExampleReduced = new CaseStudyExampleReducedNet.CaseStudyExampleReduced();
    addManagedNode(caseStudyExampleReduced);
    caseStudyExampleReduced.addMainProcess();
  }
}
